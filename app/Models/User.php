...
class User extends Authenticatable
{
    ...
    {
        return $this->email === env('ADMIN_EMAIL') || $this->administrador()->exists();
        //Para que el usuario sea administrador tanto por su email como por estar en la tabla administradores
    }
}
